...
public class InventoryController {
	...
	public List<Inventory> findByInventoryType(@RequestParam InventoryType type){
		return this.inventoryService.getByType(type);
	}
	
	@PostMapping("/add2")
	public void add2(Inventory inventory) {
		this.inventoryService.add2(inventory);
	}
